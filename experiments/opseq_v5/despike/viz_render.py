"""Shared nvdiffrast flat-shading helpers (load / lookat / persp / render / ROWS).
Used by render_compare.py (figures) and phase4_inloop.py (per-step video frames).

Original docstring: Render an N-column x 4-row visual comparison (full az150 / full az-30 /
